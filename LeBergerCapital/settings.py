"""
Django settings for LeBergerCapital project.
...
ROOT_URLCONF = 'LeBergerCapital.urls'
...
WSGI_APPLICATION = 'LeBergerCapital.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    'core.authentication.EmailAuthBackend',  # Yolu projenize göre değiştirin
...
# Media dosyalarının saklanacağı dizin yolu
